...
#
class settingsFactoryResetUI(ttk.Labelframe):
    def __init__(
        self,
        master=None,
        *,
        ...
        **kw
        ...
        self.factoryReset_Settings_Frame = ttk.Frame(
            self, name="factoryreset_settings_frame")
        self.factoryReset_Settings_Frame.configure(
            height=200, style="Normal.TFrame", width=200)
        # First object created
        on_first_object_cb(self.factoryReset_Settings_Frame)

        self.Number_Delimiter_Label = ttk.Label(
            self.factoryReset_Settings_Frame,
            name="number_delimiter_label")
        self.Number_Delimiter_Label.configure(
            justify="right", style="Heading2.TLabel", text='Reset')
        self.Number_Delimiter_Label.grid(
            column=0, padx=10, pady=10, row=0, sticky="e")
        self.factoryReset_Settings_Frame.pack(padx=10, pady=10, side="top")
...
if __name__ == "__main__":
    root = tk.Tk()
    widget = settingsFactoryResetUI(root)
