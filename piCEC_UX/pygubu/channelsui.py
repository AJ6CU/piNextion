...
class channelsUI(tk.Toplevel):
    def __init__(
        ...
        **kw
        ...
        frame1.configure(style="Normal.TFrame", width=450)
        ...
        self.header_Line_Frame.grid(column=0, pady="20 0", row=1, sticky="n")
        ...
        self.scrolledChannelFrame.innerframe.configure(
            relief="raised", style="Normal.TFrame", width=450)
        ...
        self.save_Channel_Button.configure(
            state="normal", style="Button2b.TButton", text='Save VFO')
        ...
        self.save_All_Channels_Button.grid(
            column=2, padx="10 0", pady="2 0", row=0, sticky="ns")
        self.save_All_Channels_Button.configure(
        ...
        self.scan_Select_Combobox.grid(
            column=4, padx="10 0", row=0, sticky="ns")
